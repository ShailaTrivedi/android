package com.example.pvr.androcrud;
    ...
    private void login(final String emailid, String password) {
        ...
        class LoginAsync extends AsyncTask<String, Void, String>{
            ...
            protected void onPreExecute() {
                super.onPreExecute();
                loadingDialog = ProgressDialog.show(LoginAct.this, "Please wait", "Loading...");
            }
            ...
            protected String doInBackground(String... params) {
                ...
                try{
                    ...
                    HttpPost httpPost = new HttpPost(
                            "http://192.168.0.101/androidadmin/login.php");
            ...
            protected void onPostExecute(String result){
                ...
                if(s.equalsIgnoreCase("success")){
                    ...
                    Intent intent = new Intent(LoginAct.this, FaqAct.class);
